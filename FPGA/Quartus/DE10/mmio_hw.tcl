...
set_module_property NAME mmio
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME MMIO
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL mmio
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file mmio.v VERILOG PATH mmio.v TOP_LEVEL_FILE
...
add_interface_port avalon_slave_0 addr_i address Input 6
...
set_interface_property keys associatedClock clock_sink
set_interface_property keys associatedReset reset_sink
...
add_interface_port keys keys keys Output 80
