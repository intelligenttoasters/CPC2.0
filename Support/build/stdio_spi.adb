...
S:Lstdio_spi.stdio_channel_handler$buffer$1$72({2}DG,SC:U),B,1,4
S:Lstdio_spi.stdio_channel_handler$size$1$72({1}SC:U),B,1,6
S:Lstdio_spi.stdio_channel_handler$sz$1$73({1}SC:U),B,1,-2
...
S:Lstdio_spi.spi_puts$string$1$78({2}DG,SV:S),B,1,4
S:Lstdio_spi.spi_puts$size$1$79({2}SI:S),B,1,-2
F:G$putchari$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstdio_spi.putchari$data$1$80({1}SC:U),B,1,4
F:G$putchar$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lstdio_spi.putchar$data$1$82({1}SC:U),B,1,4
F:G$outbound_flush$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$spi_avail$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$getchar$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lstdio_spi.getchar$r$1$86({1}SC:U),R,0,0,[e]
