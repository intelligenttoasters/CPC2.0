...
S:Lspi.spiSetHandler$channel$1$73({1}SC:U),B,1,4
S:Lspi.spiSetHandler$handler$1$73({2}DC,DF,SV:S),B,1,5
F:G$spiProcessEvents$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lspi.spiProcessEvents$channel$1$76({1}SC:U),B,1,-1
S:Lspi.spiProcessEvents$size$1$76({1}SC:U),R,0,0,[e]
S:Lspi.spiProcessEvents$glob$1$76({2}DG,STglobal_vars:S),R,0,0,[]
S:Lspi.spiProcessEvents$buffer$1$76({2}DG,SC:U),R,0,0,[e,d]
S:Lspi.spiProcessEvents$__00030001$6$82({1}SC:U),R,0,0,[]
...
S:Lspi.spiSetInUse$state$1$85({1}SC:U),B,1,4
F:G$spiSetProcessed$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lspi.spiSetProcessed$state$1$87({1}SC:U),B,1,4
F:G$spiLock$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lspi.spiLock$channel$1$89({1}SC:U),B,1,4
S:Lspi.spiLock$g$1$90({2}DG,STglobal_vars:S),R,0,0,[c,b]
...
S:Lspi.spiExchange$channel$1$95({1}SC:U),B,1,4
S:Lspi.spiExchange$size$1$95({1}SC:U),B,1,5
S:Lspi.spiExchange$__00010005$4$105({1}SC:U),R,0,0,[]
S:Lspi.spiExchange$g$1$96({2}DG,STglobal_vars:S),R,0,0,[c,b]
