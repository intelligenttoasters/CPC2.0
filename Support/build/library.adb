M:library
S:Llibrary.uartWrite$data$1$9({1}SC:U),B,1,4
...
T:Flibrary$global_vars[({0}S:S$console_buffer$0$0({132}DA132d,SC:U),Z,0,0)({132}S:S$usb_connected$0$0({1}SC:U),Z,0,0)({133}S:S$usb_enumerated$0$0({1}SC:U),Z,0,0)({134}S:S$usb_timeout$0$0({2}SI:U),Z,0,0)]
...
S:Flibrary$global_variables$0$0({136}STglobal_vars:S),E,0,0
